...
#         obj = models.VersionModel(version=Version.parse('0.1.1'), spec=Spec('==0.1.1,!=0.1.1-alpha'))
#
...
#         o1 = models.VersionModel(version=Version.parse('0.1.1'), spec=Spec('==0.1.1,!=0.1.1-alpha'))
...
#         o1 = models.VersionModel(version=Version.parse('0.1.1'), spec=Spec('<0.2.4-rc42'))
#         o2 = models.VersionModel(version=Version.parse('0.4.3-rc3+build3'), spec=Spec('==0.4.3'))
#
#         o1.save()
#         o2.save()
#
