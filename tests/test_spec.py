...
class FormatTests(unittest.TestCase):
    ...
    def test_major_minor_patch(self):
        ...
        with self.assertRaises(ValueError):
            Version.parse('1.2.01')
        with self.assertRaises(ValueError):
            Version.parse('1.02.1')
        with self.assertRaises(ValueError):
            Version.parse('01.2.1')
        # Valid
    ...
    def test_prerelease(self):
        ...
        with self.assertRaises(ValueError):
            Version.parse('1.2.3 -23')
        # Valid
        v = Version.parse('1.2.3-23')
        ...
        with self.assertRaises(ValueError):
            Version.parse('1.2.3-a0.01')
        with self.assertRaises(ValueError):
            Version.parse('1.2.3-00')
        # Valid
        v = Version.parse('1.2.3-0a.0.000zz')
    ...
    def test_precedence(self):
        ...
        self.assertLess(Version.parse('2.0.0'), Version.parse('2.1.0'))
        self.assertLess(Version.parse('2.1.0'), Version.parse('2.1.1'))
        ...
        self.assertLess(Version.parse('1.0.0-1'), Version.parse('1.0.0-2'))

        # and identifiers with letters or hyphens are compared lexically in
        # ASCII sort order.
        self.assertLess(Version.parse('1.0.0-aa'), Version.parse('1.0.0-ab'))

        # Numeric identifiers always have lower precedence than
        # non-numeric identifiers.
        self.assertLess(Version.parse('1.0.0-9'), Version.parse('1.0.0-a'))

        # A larger set of pre-release fields has a higher precedence than a
        # smaller set, if all of the preceding identifiers are equal.
        self.assertLess(Version.parse('1.0.0-a.b.c'), Version.parse('1.0.0-a.b.c.0'))
        ...
        self.assertLess(Version.parse('1.0.0-alpha.beta'), Version.parse('1.0.0-beta'))
        self.assertLess(Version.parse('1.0.0-beta'), Version.parse('1.0.0-beta.2'))
        self.assertLess(Version.parse('1.0.0-beta.2'), Version.parse('1.0.0-beta.11'))
        self.assertLess(Version.parse('1.0.0-beta.11'), Version.parse('1.0.0-rc.1'))
